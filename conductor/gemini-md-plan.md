# Objective
Create a `GEMINI.md` file to establish the project context, architectural guidelines, and tech stack instructions for the `construct-llm` repository.

# Key Files & Context
- `GEMINI.md`: The target file to be created in the project root.

# Implementation Steps
Create `GEMINI.md` in the root directory with the following content:
...
- Ensure the `GEMINI.md` file is located at the root of the project.
- Verify that the Gemini CLI correctly loads this context in subsequent interactions.